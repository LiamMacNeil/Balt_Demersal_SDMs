...
#png("../Figures/GAM/Spatial_autocorrelation/AdultCod_Q4_2020_blocking.png", width = 20, height = 12, res = 300, units = "cm")
sac1 <- cv_spatial_autocor(r = Q4_layers_balt[[varselect]], 
                           num_sample = 5000)
#dev.off()

#png("../Figures/GAM/Spatial_autocorrelation/AdultCod_Q4_2020_variogram.png", width = 16, height = 10, res = 300, units = "cm")
...
#png("../Figures/GAM/Spatial_autocorrelation/AdultCod_Q4_2020_blocks.png", width = 16, height = 10, res = 300, units = "cm")
...
#png("../Figures/GAM/Spatial_autocorrelation/AdultCod_Q4_2020_MESS.png", width = 16, height = 10, res = 300, units = "cm")
...
#png("../Figures/GAM/Spatial_autocorrelation/AdultCod_Q4_2020_cv.png", width = 18, height = 12, res = 300, units = "cm")
cvp <- cv_plot(cv = bloCV, 
               x = sf,
               points_alpha = 0.5,
               label_size = 3)

#ggsave("../Figures/GAM/Spatial_autocorrelation/AdultCod_Q4_2020_cv.png", cvp, width = 24, height = 14, dpi = 300, units = "cm")
...
gam2 <- mgcv::gam(Density_log10 ~ s(Bottom.salinity)+s(Bottom.temperature)+s(Bottom.oxygen)+s(Chlorophyll)+s(MLD)+s(Surface.temperature), 
...
ggsave("../Figures/GAM/Q4/AdultCod_Q4_2020_PredCor.png", pred_cor, width = 16, height = 12, units = "cm", dpi = 300)
...
write.csv(metrics, "../Model_Metrics/GAM/AdultCod_Q4_2020_GAM.csv")
...
#ggsave("../Figures/GAM/Q4/AdultCod_Q4_2020_PredDens.png", pred_dens, width = 15, height = 12, units = "cm", dpi = 300)
...
#saveRDS(mod_GAM, file = paste0("../Models/GAM/AdultCod_Q4_2020_Valid.rds"))
saveRDS(GAM_final_mod, file = paste0("../Models/GAM/AdultCod_Q4_2020_Prediction.rds"))
...
png("../Figures/GAM/Q4/AdultCod_Q4_2020_pdp.png", width = 15, height = 12, res = 300, units = "cm")
...
GAM_P <- raster("../Predictions/AdultCod_Q4_2020_GAM.tif")

png("../Figures/GAM/Q4/AdultCod_Q4_2020_predmap.png", width = 15, height = 12, res = 300, units = "cm")
plot(abs(GAM_P),
     col = viridis(20), 
...
writeRaster(GAM_P, "../Predictions/AdultCod_Q4_2020_GAM.tif", overwrite=TRUE)
