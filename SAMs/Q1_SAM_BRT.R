...
#png("../Figures/RF/Spatial_autocorrelation/AdultCod_Q1_2020_blocking.png", width = 20, height = 12, res = 300, units = "cm")
sac1 <- cv_spatial_autocor(r = Q1_layers_balt[[varselect]], 
                           num_sample = 5000)
#dev.off()

#png("../Figures/RF/Spatial_autocorrelation/AdultCod_Q1_2020_variogram.png", width = 16, height = 10, res = 300, units = "cm")
...
#png("../Figures/RF/Spatial_autocorrelation/AdultCod_Q1_2020_MESS.png", width = 16, height = 10, res = 300, units = "cm")
...
#png("../Figures/RF/Spatial_autocorrelation/AdultCod_Q1_2020_cv.png", width = 18, height = 12, res = 300, units = "cm")
cvp <- cv_plot(cv = bloCV, 
               x = sf,
               points_alpha = 0.5,
               label_size = 3)

#ggsave("../Figures/RF/Spatial_autocorrelation/AdultCod_Q1_2020_cv.png", cvp, width = 24, height = 14, dpi = 300, units = "cm")
...
ggsave("../Figures/BRT/Q1/AdultCod_Q1_2020_PredCor.png", pred_cor, width = 16, height = 12, units = "cm", dpi = 300)
...
write.csv(metrics, "../Model_Metrics/BRT/AdultCod_Q1_2020_BRT.csv")
...
model_bf_simp_final <- read_rds("../Models/BRT/Dab_Q1_2001_Prediction.rds")

png("../Figures/BRT/Q1/Dab_Q1_2001_pdp.png",  width = 22, height = 16, 
    units = "cm", res = 300)
...
saveRDS(model_bf_simp_final, file = paste0("../Models/BRT/AdultCod_Q1_2020_Prediction.rds"))

write.csv(model_bf_simp_final$contributions, "../Data/BITS_Var_RelInf/AdultCod_Q1_2020_RelInf.csv")

GBM_P <- predict(Q1_layers_balt[[simply$pred.list[[2]]]], model_bf_simp_final, type = "response", 
...
GBM_P <- raster("../Predictions/AdultCod_Q1_2020_BRT.tif")

png("../Figures/BRT/Q1/AdultCod_Q1_2020_predmap.png", width = 15, height = 12, res = 300, units = "cm")
plot(abs(GBM_P),
     col = plasma(20), 
...
writeRaster(GBM_P, "../Predictions/AdultCod_Q1_2020_BRT.tif", overwrite = T)
...
ggsave("../Figures/AdultCod_Q1_2020_PredDens.png", pred_dens, width = 15, height = 12, units = "cm", dpi = 300)
