...
ggsave("../Figures/Spring2024Revision/GAM2_Correlation_10fold_Species.png", pred_cor,
       width = 17,height = 15, units = "cm", dpi = 600)

###########################################################################
pred_cor_box <- df_result_gam2 %>% 
...
ggsave("../Figures/Spring2024Revision/GAM2_CorrelationBox_10fold_Species.png", pred_cor_box,
       width = 17,height = 15, units = "cm", dpi = 600)
...
pred_disp <- df_result_gam2 %>% 
  ...
  theme(legend.position = "none",
        axis.text.x = element_text(angle = 25, hjust=1))
ggsave("../Figures/Spring2024Revision/GAM2_Dispersion_10fold_Species.png", pred_disp,
       width = 17,height = 15, units = "cm", dpi = 600)
...
pred_mae <- df_result_gam2 %>% 
  ...
  theme(legend.position = "none",
        axis.text.x = element_text(angle = 25, hjust=1))
ggsave("../Figures/Spring2024Revision/GAM2_MAE_10fold_Species.png", pred_mae,
       width = 17,height = 15, units = "cm", dpi = 600)


patch <- pred_cor_box + pred_disp + pred_mae + plot_layout(ncol = 3, nrow = 1)
ggsave("../Figures/Spring2024Revision/GAM2_Performance_Species.png", patch,
       width = 17,height = 15, units = "cm", dpi = 600)
