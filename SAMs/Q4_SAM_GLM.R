...
#png("../Figures/GLM/Spatial_autocorrelation/CodAdult_Q4_2020_blocking.png", width = 20, height = 12, res = 300, units = "cm")
sac1 <- cv_spatial_autocor(r = Q4_layers_balt[[varselect]], 
                           num_sample = 5000)
#dev.off()

#png("../Figures/GLM/Spatial_autocorrelation/CodAdult_Q4_2020_variogram.png", width = 16, height = 10, res = 300, units = "cm")
...
#png("../Figures/GLM/Spatial_autocorrelation/CodAdult_Q4_2020_blocks.png", width = 16, height = 10, res = 300, units = "cm")
...
#png("../Figures/GLM/Spatial_autocorrelation/CodAdult_Q4_2020_MESS.png", width = 16, height = 10, res = 300, units = "cm")
...
#png("../Figures/GLM/Spatial_autocorrelation/CodAdult_Q4_2020_cv.png", width = 18, height = 12, res = 300, units = "cm")
cvp <- cv_plot(cv = bloCV, 
               x = sf,
               points_alpha = 0.5,
               label_size = 3)

#ggsave("../Figures/GLM/Spatial_autocorrelation/CodAdult_Q4_2020_cv.png", cvp, width = 24, height = 14, dpi = 300, units = "cm")
...
ggsave("../Figures/GLM/Q4/CodAdult_Q4_2020_PredCor.png", pred_cor, width = 16, height = 12, units = "cm", dpi = 300)
...
write.csv(metrics, "../Model_Metrics/GLM/CodAdult_Q4_2020_GLM.csv")
...
#ggsave("../Figures/GLM/Q4/CodAdult_Q4_2020_PredDens.png", pred_dens, width = 15, height = 12, units = "cm", dpi = 300)
...
#saveRDS(mod_GLM, file = paste0("../Models/GLM/CodAdult_Q4_2020_Valid.rds"))
saveRDS(GLM_final_mod, file = paste0("../Models/GLM/CodAdult_Q4_2020_Prediction.rds"))
...
png("../Figures/GLM/Q4/CodAdult_Q4_2020_pdp.png", width = 15, height = 12, res = 300, units = "cm")
do.call("grid.arrange", c(p, ncol=nCol))
dev.off()

GLM_P <- predict(Q4_layers_balt[[varselect]], GLM_final_mod, type = "response")
GLM_P<- crop(mask(GLM_P, icesarea), extent(icesarea)) 

# Back-transformation (log10) to kg km^-2
GLM_P <- (10^(GLM_P)-1)/1000

GLM_P <- raster("../Predictions/CodAdult_Q4_2020_GLM.tif")

png("../Figures/GLM/Q4/CodAdult_Q4_2020_predmap.png", width = 15, height = 12, res = 300, units = "cm")
plot(abs(GLM_P),
     col = viridis(20), 
...
writeRaster(GLM_P, "../Predictions/CodAdult_Q4_2020_GLM.tif", overwrite=TRUE)
